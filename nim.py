...
class NimAI():
    ...
    def get_q_value(self, state, action):
        ...
        # Check if (state_tuple, action) is in self.q
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        """
        # We calculate the new estimate as the task says
    ...
    def best_future_reward(self, state):
        ...
        """
        state = tuple(state)
        # We get all the possible actions
        actions = Nim.available_actions(state)
        if not actions:
            return 0
        
        # We get the best reward for any action available 
    ...
    def choose_action(self, state, epsilon=True):
        ...
        actions = list(Nim.available_actions(state_tuple))
        
        # Check if we should use epsilon-greedy approach
        if epsilon:
